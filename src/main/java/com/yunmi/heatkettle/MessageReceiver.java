...
import com.yunmi.heatkettle.activity.UMMainScreenActivity;
        ...
        switch (type) {
            ...
            case PUSH_MESSAGE: {
                ...
                if ("DevicePush".equals(msgType)) {// 订阅的消息
                    ...
                    UMKettleDevice device = UMKettleDevice.getDevice(deviceStat);
                    ...
                    Log.d(UMKettleDevice.MODEL, "ScenePush :" + event + "  " + extra);
                    //TODO 处理场景通知
                }
            }
            default:
